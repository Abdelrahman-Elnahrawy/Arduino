...
const char* mqtt_password =   "eiphuth2aibah3kee7cugaeGh3phosh6toh2nah5aeti9ael4aa9Mie8piequah9" ;
...
digitalWrite(relay1,R1);
    ...
    Serial.print("Publish message**FOR TEST: ");
    Serial.println(msg);
...
digitalWrite(relay2,R2);
    snprintf (msg, MSG_BUFFER_SIZE, "XXXXXR2:%d",R2);
    Serial.print("Publish message**FOR TEST: ");
    Serial.println(msg);
    client.publish(Pub, msg);
EEPROM.write(102,R2);
...
digitalWrite(relay3,R3);
    snprintf (msg, MSG_BUFFER_SIZE, "XXXXXXXXXXR3:%d",R3);
    Serial.print("Publish message**FOR TEST: ");
    Serial.println(msg);
    client.publish(Pub, msg);
EEPROM.write(103,R3);
...
LM=0;
 ...
 EEPROM.commit();  
   snprintf (msg, MSG_BUFFER_SIZE, "MSG No. #%d recived",S);
    snprintf (msg, MSG_BUFFER_SIZE, "R1:%d R2:%d R3:%d T:%03d D:%04d LM:%d  #%ld ",R1,R2,R3,T,LD,LM,MSG_NO);
   client.publish(Pub, msg);  
    yield();  }
